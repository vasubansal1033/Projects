...
// const light = new THREE.PointLight(0xff9000, 0.5, 1)
// light.position.set(1, -0.5, 0)

// const pointLightHelper = new THREE.PointLightHelper(light, 0.2);
// scene.add(pointLightHelper)

// const light = new THREE.DirectionalLight(0x00fffc, 0.3);
// light.position.set(1, 0.25, 0)

// const directionalLightHelper = new THREE.DirectionalLightHelper(light, 0.2);
// scene.add(directionalLightHelper)

// const light = new THREE.HemisphereLight(0xff0000, 0x0000ff, 0.5)

// const light = new THREE.RectAreaLight(0xff9000, 0.5, 3, 3);
